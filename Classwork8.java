...
public class Classwork8
{
    ...
    **/
    ...
    /** Question 12: Define a function to determine if a number entered is even, then returns that number 
    ** times 5. If ** the number entered is odd and is divisible by 5, then the function returns that number
    ** divided by five. If the 
